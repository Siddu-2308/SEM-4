...
void transplant(BSTree *T, Node *u, Node *v)
{
	...
	/*Steps:
	1️⃣ Fix parent pointer of u
	2️⃣ Fix parent pointer of v*/
...
{    //****************************
	...
	2. If node has 0 children → remove it
	3. If node has 1 child → replace with child
	4. If node has 2 children → replace with successor*/
	if(z->left==NULL){
